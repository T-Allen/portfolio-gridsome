    ...
    <div class="flex flex-col justify-center items-center h-full xl:h-screen">
      <div class="flex flex-col items-center justify-around lg:flex-row w-full px-6 xl:px-20">
        <div class="flex flex-col order-2 lg:order-none z-50"> 
          <Grid class="grid grid-card-xs sm:grid-card slide-right" :itemList="$page.previews.edges">
        ...
        <p class="font-bold font-body max-w-lg text-secondary text-xl md:text-4xl lg:ml-12 mb-12 lg:mb-0 order-1 lg:order-none slide-right lg:slide-left" v-text="$page.author.bio"></p>
      </div>
    </div>
